...
import static io.netty.contrib.multipart.vintage.HttpPostBodyUtil.TransferEncodingMechanism;
import static io.netty.contrib.multipart.vintage.HttpPostRequestDecoder.EndOfDataDecoderException;
import static io.netty.contrib.multipart.vintage.HttpPostRequestDecoder.MultiPartStatus;
import static io.netty.contrib.multipart.vintage.HttpPostRequestDecoder.NotEnoughDataDecoderException;
    ...
    private void parseBody() {
        while (true) {
            ...
            switch (event) {
                ...
                case CONTENT:
                    try {
                        ((HttpData) currentPartialHttpData()).addContent(decoder.decodedContent(), false);
                    } catch (IOException e) {
                        throw new ErrorDataDecoderException(e);
                    }
                    break;
